...
function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#050816] text-white flex overflow-hidden">
      {/* Sidebar - Fixed Width + Translate Only (Smooth) */}
      <div
      ...
      >
        {/* Header */}
        <div className="p-6 flex items-center justify-between border-b border-[#2d4fff]/20 sticky top-0 bg-[#0b1330]">
      ...
      <div className="flex-1 flex flex-col min-h-screen w-full">
        {/* Top Navbar */}
        <header className="bg-[#0b1330] border-b border-[#2d4fff]/30 px-4 sm:px-6 py-4 flex items-center justify-between sticky top-0 z-40">
          <div className="flex items-center gap-4">
            <button
              onClick={() => setSidebarOpen(!sidebarOpen)}
              className="text-[#8ea2ff] hover:text-white p-3 rounded-2xl hover:bg-[#1a254f] transition-all active:scale-95"
