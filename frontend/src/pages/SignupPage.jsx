    ...
    <div className="min-h-screen bg-[#050816] text-white overflow-hidden relative">
      ...
      <div className="max-w-2xl mx-auto relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex items-center justify-between p-6">
          <a
            href="/"
            className="text-[#8ea2ff] hover:text-white flex items-center gap-2 text-sm sm:text-base"
          >
          ...
          <div className="w-full max-w-xl">
            ...
            <div className="mb-10">
              <div className="flex justify-between text-xs sm:text-sm mb-3 px-1">
                {["Account Info", "Connect Wallet", "Complete Profile"].map(
                  (label, index) => (
                    <div
                      key={index}
            ...
            <div className="bg-[#0b1330] border border-[#2d4fff]/30 rounded-3xl p-6 sm:p-10">
              {currentStep === 1 && (
                <div className="space-y-6">
                  <div>
                    <label className="block text-[#8ea2ff] text-sm mb-2">
                      Username
                    </label>
                    <input
                      type="text"
                ...
                <div className="text-center py-16">
                  ...
                  <button
                    onClick={() =>
                      updateForm(
                        "walletAddress",
                        "0x742d35Cc6634C0532925a3b8D7F5a8f3e8d2",
                      )
                    }
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-[#8ea2ff] text-sm mb-3">
                      Interests (Optional)
                    </label>
