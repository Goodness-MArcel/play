...
import {signup} from '../utils/index.js'
...
function SignupPage() {
  ...
  const interestsOptions = [
    "Digital Art", "3D", "Music", "Photography", "Gaming",
    "Collectibles", "Anime", "Metaverse",
  ];
    ...
    <div className="min-h-screen bg-[#050816] text-white overflow-hidden relative">
      ...
      <div className="max-w-2xl mx-auto relative z-10 min-h-screen flex flex-col">
        <div className="flex items-center justify-between p-6">
          ...
          <div className="text-xl font-bold tracking-widest text-white/80">Sign Up</div>
        </div>
          ...
          <div className="w-full max-w-xl">
            ...
            <div className="mb-10">
              <div className="flex justify-between text-xs sm:text-sm mb-3 px-1">
                {["Account Info", "Complete Profile"].map((label, index) => (
                  <div
                    key={index}
            ...
            <div className="flex justify-between mt-8 px-2">
              ...
              {currentStep < 2 ? (
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="flex items-center gap-2 bg-gradient-to-r from-[#5f7dff] to-[#8ea2ff] px-10 py-3 rounded-2xl font-semibold hover:scale-105 transition-all text-base sm:text-lg disabled:opacity-70"
                >
